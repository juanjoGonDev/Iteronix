                ...
                [
                  createElement("div", { className: "relative flex-1" }, [
                    ...
                    createElement("input", {
                      ...
                      className:
                        "block w-full pl-10 pr-3 py-2.5 bg-surface-dark border border-border-dark rounded-lg text-white placeholder-text-secondary focus:ring-1 focus:ring-primary focus:border-primary sm:text-sm font-medium transition-shadow",
                    }),
                  ]),
                  createElement("div", { className: "flex gap-3" }, [
                    createElement(
                      ...
                      {
                        className:
                          "bg-surface-dark border border-border-dark text-white text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5 min-w-[140px] appearance-none cursor-pointer",
                      },
                      [
                        createElement("option", { value: "all" }, [
                          "All Statuses",
                        ]),
                        createElement("option", { value: "running" }, [
                          "Running",
                        ]),
                        createElement("option", { value: "completed" }, [
                          "Completed",
                        ]),
                        createElement("option", { value: "failed" }, [
                          "Failed",
                        ]),
                      ],
                    ),
                  ...
                  createElement(
                    ...
                    [
                      createElement(
                        ...
                        {
                          className:
                            "bg-surface-dark-hover/50 text-xs uppercase text-text-secondary font-semibold border-b border-border-dark",
                        },
                        [
                          createElement("tr", {}, [
    ...
    return createElement(
      ...
      [
            ...
            createElement("div", {}, [
              ...
              createElement(
                "a",
                {
                  href: "#",
                  className:
                    "text-xs text-text-secondary hover:text-primary font-mono flex items-center gap-1 mt-0.5",
                },
                [
                  project.repo,
                  createElement(
            ...
            project.stack.map((tech) =>
              createElement(
                "div",
                {
                  key: tech,
                  className:
                    "size-7 rounded-full bg-[#2b3644] border-2 border-surface-dark flex items-center justify-center text-[10px] text-white font-bold",
                  title: tech,
                },
                [tech],
              ),
        ...
        createElement("td", { className: "px-6 py-4 text-right" }, [
          createElement("div", { className: "text-sm text-text-secondary" }, [
            project.lastUpdated,
          ]),
          createElement(
            "div",
            { className: "text-xs text-text-secondary/60 font-mono" },
            [project.version],
          ),
        ]),
