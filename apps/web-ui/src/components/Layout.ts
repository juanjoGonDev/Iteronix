        ...
        createElement("div", { className: "flex items-center gap-2 text-sm" }, [
          ...
          title &&
            createElement("div", { className: "flex items-center gap-2" }, [
              ...
              createElement("span", { className: "text-white font-medium" }, [
                title,
              ]),
            ]),
        ]),
        ...
        createElement("div", { className: "flex items-center gap-3" }, [
          ...
          actions.status &&
            createElement(
              ...
              {
                className:
                  "flex items-center gap-4 mr-4 px-3 py-1.5 rounded-full bg-surface-dark border border-border-dark",
              },
              [
                actions.status.api &&
                  createElement(
                    ...
                    [
                      createElement("div", {
                        className:
                          "size-2 rounded-full bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)]",
                      }),
                      createElement(
                        "span",
                        {
          ...
          actions.cost &&
            createElement("div", { className: "flex items-center gap-2" }, [
              createElement(
                ...
                {
                  className:
                    "material-symbols-outlined text-[18px] text-purple-400",
                },
                ["smart_toy"],
              ),
              createElement(
              ...
              createElement(
                ...
                {
                  className:
                    "font-mono text-xs font-bold text-white group-hover:text-primary transition-colors",
                },
                [actions.cost.amount],
              ),
            ]),
          ...
          this.props.user &&
            createElement(
              "button",
              {
                type: "button",
                className:
                  "flex items-center gap-2 rounded-xl border border-border-dark bg-surface-dark px-2.5 py-2 text-left transition-colors hover:bg-surface-dark-hover",
              ...
              [
                ...
                createElement(
                  ...
                  {
                    className:
                      "hidden max-w-32 truncate text-sm font-medium text-white md:inline",
                  },
