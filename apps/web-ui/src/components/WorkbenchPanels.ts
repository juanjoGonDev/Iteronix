    ...
    return createElement(Card, {
      ...
      children: [
        createElement(
          ...
          {
            className:
              "flex items-start justify-between gap-4 border-b border-border-dark pb-4",
          },
          [
...
export class CitationsList extends Component<CitationsListProps> {
  override render(): HTMLElement {
    ...
    const citationGroups = createCitationEvidenceGroups(
      citations,
      evidenceSources,
    );
      ...
      [
        ...
        citations.length === 0
          ? createElement(
              ...
              {
                className:
                  "rounded-lg border border-dashed border-border-dark px-3 py-4 text-sm text-text-secondary",
              },
              [emptyLabel],
            )
                          ...
                          [
                            onSourceSelect
                              ? createElement(Button, {
                                  variant:
                                    group.citation.sourceId === activeSourceId
                                      ? "secondary"
                                      : "ghost",
                                  size: "sm",
                                  onClick: () =>
                                    onSourceSelect(group.citation.sourceId),
                                  children:
                                    group.citation.sourceId === activeSourceId
                                      ? "Focused"
                                      : "Focus evidence",
                            ...
                            createElement(
                              "span",
                              { className: "text-xs text-text-secondary" },
                              [formatTimestamp(group.citation.retrievedAt)],
                            ),
                          ],
                        ),
                      ],
...
export const createCitationEvidenceGroups = (
  ...
  citations.map((citation) => ({
    citation,
    provenance: evidenceSources.filter(
...
export class EvidenceReportPanel extends Component<
  EvidenceReportPanelProps,
  EvidenceReportPanelState
> {
  ...
  override render(): HTMLElement {
    ...
    const sourceSummaries = createEvidenceSourceSummaries(
    ...
    const filteredSources = filterEvidenceSourcesBySourceId(
      report.retrievedSources,
      activeSourceId,
    );
    const activeSourceSummary = activeSourceId
      ? (sourceSummaries.find(
          (summary) => summary.sourceId === activeSourceId,
        ) ?? null)
      : null;
    ...
    return createElement(
      ...
      [
        createElement(
          ...
          [
            ...
            createElement(
              ...
              {
                className:
                  "mt-3 text-xs uppercase tracking-wide text-text-secondary",
              },
              ["Signals"],
            ),
              ...
              report.confidence.signals.map((signal) =>
                createElement(
                  "span",
                  {
                    key: signal,
                    className:
                      "rounded-md border border-border-dark px-2 py-1 text-xs text-text-secondary",
                  },
                  [signal],
                ),
              ),
          ...
          [
            ...
            createElement(
              ...
              [
                ...
                renderDefinition(
                  "Completion",
                  String(report.usage.completionTokens),
                ),
        ...
        createElement(
          ...
          {
            className:
              "rounded-lg border border-border-dark bg-background-dark/40 px-3 py-3 md:col-span-2",
          },
          [
            createElement(
              "h3",
            ...
            createElement(
              ...
              {
                className:
                  "mt-3 flex flex-col gap-2 text-sm text-text-secondary",
              },
              [
                report.decisions.map((decision, index) =>
                  createElement(
                    "li",
                    {
                      ...
                      className:
                        "rounded-md border border-border-dark px-3 py-2",
                    },
                    [decision],
                  ),
                ),
          ...
          [
            ...
            report.guardrailsTriggered.length === 0
              ? createElement(
                  ...
                  ["No guardrail violations were recorded."],
                )
              : createElement(
                  "ul",
                  {
          ...
          [
            ...
            sourceSummaries.length === 0
              ? createElement(
                  "p",
                  { className: "mt-3 text-sm text-text-secondary" },
                  ["No retrieved sources were recorded."],
                )
              : createElement(
                  "div",
                  ...
                  [
                    sourceSummaries.map((summary) =>
                      renderEvidenceSourceSummary(
                        summary,
                        summary.sourceId === activeSourceId,
                        () => this.handleSourceFilter(summary.sourceId),
                      ),
                    ),
                  ],
                ),
          ...
          [
            ...
            filteredSources.length === 0
              ? createElement(
                  "p",
                  { className: "mt-3 text-sm text-text-secondary" },
                  ["No retrieved chunks match the current source filter."],
                )
              : createElement(
                  "div",
                  { className: "mt-3 flex flex-col gap-2" },
                  [
                    filteredSources.map((source) =>
                      renderRetrievedEvidenceChunk(source),
                    ),
                  ],
                ),
          ],
              ...
              createElement(
                ...
                [
                    ...
                    [
                      ...
                      createElement("div", { className: "flex flex-col" }, [
                        createElement(
                          ...
                          {
                            className:
                              "text-sm font-medium capitalize text-white",
                          },
                          [step.stage],
                        ),
                        createElement(
                  ...
                  createElement(
                    ...
                    {
                      status:
                        step.status === "completed" ? "success" : "warning",
                    },
      ...
      [
        items.length === 0
          ? createElement(
              ...
              ["No session memory retrieved yet."],
            )
          : items.map((item) =>
              createElement(
                "div",
      ...
      children: [
        createElement("div", { className: "flex flex-col items-start gap-3" }, [
          createElement(
            ...
            {
              className:
                "material-symbols-outlined text-2xl text-text-secondary",
            },
            [icon],
          ),
          createElement("div", { className: "flex flex-col gap-1" }, [
...
class WorkbenchTextField extends Component<WorkbenchTextFieldProps> {
  override render(): HTMLElement {
    const {
      label,
      value,
    ...
    return createElement("label", { className: "flex flex-col gap-2" }, [
      createElement("span", { className: "text-sm font-medium text-white" }, [
        label,
      ]),
      createElement("input", {
        type,
...
class WorkbenchMetaCell extends Component<WorkbenchMetaCellProps> {
  override render(): HTMLElement {
    const { label, value } = this.props;

    return createElement(
      "div",
      { className: readWorkbenchMetaCellClassName() },
      [
        createElement(
          "p",
...
export const renderWorkbenchTextField = (
  input: WorkbenchTextFieldProps,
): HTMLElement => createElement(WorkbenchTextField, input);

export const renderWorkbenchMetaCell = (
  label: string,
  value: string,
): HTMLElement => createElement(WorkbenchMetaCell, { label, value });
...
const renderDefinition = (label: string, value: string): HTMLElement =>
  createElement("div", { className: "flex flex-col gap-1" }, [
    ...
    createElement("dd", { className: "text-sm font-medium text-white" }, [
      value,
    ]),
  ]);
  ...
  createElement(
    ...
    [
      ...
      createElement(
        ...
        {
          className:
            "shrink-0 rounded-md border border-border-dark px-2 py-1 text-xs uppercase tracking-wide text-text-secondary",
        },
...
const renderRetrievedEvidenceChunk = (source: Citation): HTMLElement =>
  createElement(
    "div",
    {
      key: source.chunkId,
      className:
        "rounded-md border border-border-dark bg-background-dark/40 px-3 py-3",
    },
    [
      createElement(
        "div",
        ...
        [
          createElement("div", { className: "min-w-0" }, [
            createElement(
              ...
              {
                className:
                  "truncate text-xs uppercase tracking-wide text-text-secondary",
              },
              [source.chunkId],
            ),
            createElement(
...
const renderCitationProvenance = (group: CitationEvidenceGroup): HTMLElement =>
  createElement(
    ...
    {
      className:
        "mt-3 overflow-hidden rounded-lg border border-border-dark bg-surface-dark/60",
    },
    [
      createElement(
        "summary",
      ...
      createElement(
        ...
        {
          className:
            "flex flex-col gap-2 border-t border-border-dark px-3 py-3",
        },
        [
